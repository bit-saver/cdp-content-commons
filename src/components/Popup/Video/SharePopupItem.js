        ...
        <PopupContent>
          ...
          >
            <ClipboardCopy
              ...
              copyItem="[loremipsum.lipsum.lorem1]"
              info="Display this video with closed captions"
            />
            <ClipboardCopy
              label="Open Captions"
              copyItem="[loremipsum.lipsum.lorem2]"
              info="Display this video with open captions"
            />
            <ClipboardCopy
              label="Source File"
              copyItem="[loremipsum.lipsum.lorem3]"
              info="Display original video with open captions in multiple languages"
            />
          </PopupContentItem>
          ...
          >
            <ClipboardCopy
              label="YouTube URL"
              copyItem="https://loremipsum.youtube.lorem"
              info="Link to this video on YouTube"
            />
            <ClipboardCopy
              label="Vimeo URL"
              copyItem="https://loremipsum.vimeo.lorem"
              info="Link to this video on Vimeo"
            />
          </PopupContentItem>
